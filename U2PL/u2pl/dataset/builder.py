...
from .customs import build_customs_semi_loader, build_customsloader
...
def get_loader(cfg, seed=0):
    ...
    if cfg_dataset["type"] == "cityscapes_semi":
        ...
        logger.info("Get loader Done...")
        return train_loader_sup, val_loader
    elif cfg_dataset["type"] == "customs_semi":
        train_loader_sup, train_loader_unsup = build_customs_semi_loader("train", cfg, seed=seed)
        val_loader = build_customs_semi_loader("val", cfg)
        logger.info("Get loader Done...")
        return train_loader_sup,train_loader_unsup, val_loader
    else:
